            ...
            <div class="uk-containerX">
                <div class="body-header" style="padding-top: 10px;">
                    <div class="uk-grid uk-grid-preserve k-rtl">
                        ...
                        <base:comboBoxAutoComplete name="member" value="lastname" styleClass="larg"
                                                   dataTextField="lastname" dataValueField="id"
                                                   key="thinkroom.membermanagent.member.lastname"
                                                   comboLoaderUrl="<%=comboLoaderUrl%>" minLength="0" hasTemplate="true"
                                                   headerTemplateComaSep="thinkroom.membermanagent.member.name,thinkroom.membermanagent.member.lastname,thinkroom.membermanagent.member.cellphone,thinkroom.membermanagent.member.email"
                                                   templateComaSep="name,lastname,cellphone,email"/>
                        <base:button id="button-add" key="action.add" styleClass="" align="right" style="width: 100%;" stylediv="width: 4%;padding-right: 0px;"/>
...
//                $("#grid").data("kendoGrid").dataSource.read();
        ...
        $("#button-select").click(function () {
            ...
            if($("#member_Comb").val().length!=0){
                tmp["member_id"]=member.value;
            }
            jQuery.ajax ({
                ...
                success: function(result){
                    ...
                    if(result.state == "success"){
                        ...
                        var urlGrid=$("#MemberSession").data("kendoGrid").dataSource.transport.options.read.url;
...
//                                    urlGrid=subUrlGrid.valueOf()+"/"+document.getElementById("id").value;
                        ...
                        $("#MemberSession").data("kendoGrid").dataSource.transport.options.read.url=urlGrid;
                        $("#MemberSession").data("kendoGrid").dataSource.read();
