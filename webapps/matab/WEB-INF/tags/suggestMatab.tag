...
<%@ attribute name="onSelect" required="true" rtexprvalue="true" %>
<%@ attribute name="urlEditMode" required="false" rtexprvalue="true" %>
		...
		$(document).ready(function() {
                    ...
                    $("#${name}_Comb").kendoComboBox({
                        ...
                        dataBound: function(e) {
                            if(firstBind==true && "${urlEditMode}"!=null && window.location.href.indexOf("${urlEditMode}")>-1){
