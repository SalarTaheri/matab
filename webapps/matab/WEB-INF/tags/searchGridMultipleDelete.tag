...
<button class="uk-button uk-button-danger" type="button" onclick="javascript:operation('patternMultipleDelete')" id="patternMultipleDelete" style="${style}">
                ...
                success: function (data, success, xhr) {
                    if (data.state == "error") {
                        for (var i = 0; i < data.errors.length; i++) {
                            alertify.error(data.errors[i].Message);
                        }
                    }else{
