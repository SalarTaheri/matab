...
%>
	...
	<div class="k-rtl">	
		<kendo:grid  name="${name}" selectable="${selectable}" pageable="true" sortable="true" height="400"
                     columnReorder="true" columnResize="true" filterable="true" navigatable="true" >
	            	...
	            	<kendo:grid-column-command >
                        ...
                        <%for(MyFunctionTag myFunctionTag : functions) {
                            if(GlobalVariable.getButtonContainer(menuSysCode4Grid,myFunctionTag.getName())){
	                            ...
	                            if(!isPopup){%>
	                                <kendo:grid-column-commandItem className="<%=style%>" click="<%=myFunctionTag.getFunctionClick() %>"  name="<%=myFunctionTag.getName() %>" text="<%=myFunctionTag.getText() %>"/>
	                            <%} else {%>
