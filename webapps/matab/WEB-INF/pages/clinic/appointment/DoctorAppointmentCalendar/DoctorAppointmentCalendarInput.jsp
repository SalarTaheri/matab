...
<div class="uk-container uk-container-center my-uk-container" >
	<form class="uk-form" id="mainForm">
		...
		<div class="uk-grid uk-grid-preserve">
			...
			<base:cascadeComboBox name="weekTemplateId" cascadeCombo="doctorId" comboLoaderUrl="combo/loadAllWeekTemplateByDoctor" key="com.artonis.clinic.appointment.doctroAppointmentCalendar.weekTemplateName" styleClass="small"/>
