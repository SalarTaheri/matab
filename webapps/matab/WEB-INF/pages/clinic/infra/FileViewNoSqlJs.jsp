...
<script type="text/template" id="p_kanban_tmpl">
    <div class="uk-width-1-5 p-kanban-card p-cards-{{=it.count}}" id="card_{{=it.uid}}">
        <div class="uk-panel uk-panel-box">
            <div class="uk-panel-badge uk-badge p-count">{{=it.count}}</div>
            <h3 class="uk-panel-title">{{=it.title }}</h3>
            <div class="p-card-links">
                <a class="p-card-details" href="#">Details</a>
                <a class="p-card-prescription" href="#">Prescription</a>
            </div>
        </div>
    </div>
</script>
