...
<div class="uk-container uk-container-center my-uk-container" >
    <form class="uk-form" id="mainForm">
        <div class="uk-grid uk-grid-preserve">
            <base:multiSelect serverFilter="true" name="doctor_ids" styleClass="verylarg"  multiSelectLoaderUrl="combo/loadAllDoctor" key="his.patient.doctorName" />
        ...
        <%--<base:searchButton defaultReadUrl="${basePath}sql-grid-read"/>--%>
        <%--<div class="uk-grid uk-grid-preserve">--%>
        <%--</div>--%>
        <%--<base:mehrSys-sql-grid  sqlQueryKey="abbas" name="searchGrid" selectable="multiple" showOperation="false"--%>
        ...
        <base:my-grid-search  showMultipleDelete="false"  showOperation="false" scrollable="true">
            ...
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.serviceItemAmountSum' field="serviceItemAmountSumStr"  width="70px"/>
            ...
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.clinicDiscount' field="clinicDiscountStr"  width="60px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.doctorDiscount' field="doctorDiscountStr"  width="60px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.bothDiscount' field="bothDiscountStr"  width="60px"/>
            ...
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.doctorPortionInsurance' field="doctorPortionInsuranceStr"  width="80px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.clinicPortionInsurance' field="clinicPortionInsuranceStr"  width="80px"/>
...
//            $("#doctor_id").val(employeeId);
            $("#doctor_ids_multiSelect").data("kendoMultiSelect").value(employeeId);
            $("#doctor_ids_multiSelect").data("kendoMultiSelect").enable(false);;
        }
...
//        docVar.service_id=$("#service_id").val();
    ...
    function doAfterSearch(searchString){
        $.ajax({
            url:'${pageContext.request.contextPath}' + '/clinic/operation/factorDoctorClinicPortionBasedDoctorBehboodAggregate/sumTotalCost/' + searchString,
