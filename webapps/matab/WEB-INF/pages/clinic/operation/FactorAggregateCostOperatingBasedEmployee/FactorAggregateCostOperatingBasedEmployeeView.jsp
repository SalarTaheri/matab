...
<div class="uk-container uk-container-center my-uk-container" style="margin-bottom: 1;" >
    <form class="uk-form" id="mainForm">
        <div class="uk-grid uk-grid-preserve">
            ...
            <base:checkbox name="showPriceGreaterThanZero" key="com.artonis.clinic.operation.factorAggregateCostOperatingBasedEmployee.showPriceGreaterThanZero"
            		 styleClass="verysmall" divLableStyle="width: 20%;" style="width: 15%; margin-top: 5px;"/>
        </div>
        <div class="uk-grid uk-grid-preserve">
...
<script type="text/javascript">
    ...
    function getSearchObject(){
        ...
        docVar.showPriceGreaterThanZero = $("#showPriceGreaterThanZero").is(":checked");
