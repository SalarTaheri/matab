...
<div >
    <form class="uk-form">
        ...
        <base:my-grid name="gridPatient" isPopup="true" transportReadUrl="<%=gridDetailUrl%>" showOperation="false">
            <base:my-grid-column title='com.artonis.clinic.operation.factor.patient_fileNumber'  field="patientFileNumber" width="25px"/>
            ...
            <base:my-grid-column title='com.artonis.clinic.basicInfo.financeRegistration.grid.insurance'  field="insuranceCost" width="25px"/>
            ...
            <base:my-grid-schema-field name="patientFullName" type="string"/>
