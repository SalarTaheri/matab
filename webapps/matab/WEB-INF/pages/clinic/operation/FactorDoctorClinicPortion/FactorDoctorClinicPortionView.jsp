...
<div class="uk-container uk-container-center my-uk-container" >
    <form class="uk-form" id="mainForm">
        ...
        <div class="uk-grid uk-grid-preserve">
            ...
            <base:comboBox name="employeeContractPercentState" styleClass="small" key="com.artonis.clinic.operation.factorView.emplyeeContractPercentState" comboLoaderUrl="combo/allEmployeeContractState"/>
        </div>
        <base:my-grid-search  showMultipleDelete="false"  scrollable="true" showOperation="false">
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.service_item_name' field="service_item_name"  width="40px"/>
            ...
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.patientCount' field="patientCount"  width="15px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.serviceItemAmountSum' field="serviceItemAmountSumStr"  width="35px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.totalReceiveCostSum' field="totalReceiveCostSumStr"  width="35px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.insuranceAmountSum' field="insuranceAmountSumStr"  width="35px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.clinicDiscount' field="clinicDiscountStr"  width="30px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.doctorDiscount' field="doctorDiscountStr"  width="30px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.bothDiscount' field="bothDiscountStr"  width="30px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.doctorPortionReceiveCostSum' field="doctorPortionReceiveCostSumStr"  width="35px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.clinicPortionReceiveCostSum' field="clinicPortionReceiveCostSumStr"  width="35px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.doctorPortionInsurance' field="doctorPortionInsuranceStr"  width="25px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.clinicPortionInsurance' field="clinicPortionInsuranceStr"  width="25px"/>
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.emplyeeContractPercentState' field="isVariablePercentStr"  width="25px"/>
			...
			<base:my-grid-function text="com.artonis.clinic.operation.factorDoctorClinicPortion.popup.serviceDetail" functionClick="grid_onDetail"  name="detail"/>
        </base:my-grid-search>
    </form>
...
<base:popupGrid gridPopupName="gridDetial" selectGridName="searchGrid" relativePopupUrl="popup/detailPatient" fieldQueryPopup="serviceItemId,doctor_id,date"
