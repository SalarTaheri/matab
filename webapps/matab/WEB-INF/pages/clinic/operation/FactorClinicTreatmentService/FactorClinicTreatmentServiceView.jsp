...
<div class="uk-container uk-container-center my-uk-container" >
    <form class="uk-form" id="mainForm">
        <div class="uk-grid uk-grid-preserve">
            ...
            <base:multiSelect serverFilter="true" name="service_id" styleClass="small" multiSelectLoaderUrl="combo/allService" key="com.artonis.clinic.operation.factorView.service_name" />
...
<script type="text/javascript">
    ...
    function getSearchObject(){
        ...
        docVar.service_ids=$("#service_id_multiSelect").val();
        ...
        var serviceIdDataItems=$("#service_id_multiSelect").data("kendoMultiSelect")._dataItems;
        if(serviceIdDataItems!=undefined &&serviceIdDataItems.length>0){
            var service_valueText='';
            for(var i=0;i<serviceIdDataItems.length;i++){
                service_valueText+=serviceIdDataItems[i].ComboCaption+' , ';
            }
            docVar.service_text=service_valueText.substring(0,service_valueText.length-3);
        }
