...
<div class="uk-container uk-container-center my-uk-container" >
    <form class="uk-form" id="mainForm">
        ...
        <base:my-grid-search  showMultipleDelete="false"  showOperation="false" scrollable="true">
            ...
            <base:my-grid-column title='com.artonis.clinic.basicInfo.serviceItemCost.equipment' field="service_item_name"  width="50px"/>
    ...
    <div style="text-align: center">
        <base:buttonPopup formPopup="ConsumptionSlipItem" key="com.artonis.clinic.operation.factorView.consumptionslip"
                          ...
                          selectAllOnNotSelected="true" selectAllOnNotSelectedUrl="loadIds/" bindEntityRequestType="POST"/>
...
<script type="text/javascript">
    ...
    function doAfterSearch(searchString){
        $.ajax({
            url:'${pageContext.request.contextPath}' + '/clinic/operation/factorClinicEquipmentDetailDepartment/sumTotalCost/' + searchString,
