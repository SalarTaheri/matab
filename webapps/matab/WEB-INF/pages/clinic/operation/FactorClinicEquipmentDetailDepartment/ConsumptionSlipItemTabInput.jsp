...
<form class="uk-form2-uk-form2-ConsumptionSlipItem">
    ...
    <div class="uk-grid uk-grid-preserve">
        <base:testBox styleClass="small" value="com.artonis.inv.slip.consumptionSlip" name="documentType"
                      disabled="true" dataIgnore="true" key="com.artonis.inv.slip.consumptionSlip.documentType"/>
