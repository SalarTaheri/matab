...
<div class="uk-container uk-container-center my-uk-container" >
    <base:my-grid-search  showMultipleDelete="false" >
        ...
        <base:my-grid-schema-field name="sumCashPayment" type="long" />
        <base:my-grid-schema-field name="sumPosPayment" type="long" />
...
<script type="text/javascript">
    ...
    function doAfterSearch(searchString){
        $.ajax({
            url:'${pageContext.request.contextPath}' + '/clinic/operation/FactorPaymentPerPatient/sumTotalCost/' + searchString,
