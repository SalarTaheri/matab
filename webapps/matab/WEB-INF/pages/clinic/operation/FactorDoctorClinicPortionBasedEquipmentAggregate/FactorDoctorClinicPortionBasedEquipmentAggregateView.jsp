...
<div class="uk-container uk-container-center my-uk-container" >
    <form class="uk-form" id="mainForm">
        ...
        <base:my-grid-search  showMultipleDelete="false"  showOperation="false" scrollable="true">
            ...
            <base:my-grid-column title='com.artonis.clinic.basicInfo.serviceItemCost.equipment' field="service_item_name"  width="80px"/>

            <base:my-grid-column title='com.artonis.clinic.basicInfo.serviceItemCostEquipment.quantity' field="quantityStr"  width="50px"/>
            ...
            <base:my-grid-column title='com.artonis.clinic.operation.factorView.totalReceiveCostSum' field="totalReceiveCostSum"  width="70px"/>
            ...
            <base:my-grid-schema-field name="totalReceiveCostSum" type="long" />
