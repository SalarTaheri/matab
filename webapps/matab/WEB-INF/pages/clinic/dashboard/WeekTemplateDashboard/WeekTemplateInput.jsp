...
<div class="uk-container uk-container-center my-uk-container" >
	...
	<base:itemForm titleKeys="com.clinic.appointment.weekTemplate.weekDays"
				   formItemTabViewJspFiles="DayItemTabView.jsp"
				   formItemTabInputs="DayItemTabInput"
	 			   insertWithoutPopup="true" masterIdStr="goods_id"/>
</div>
