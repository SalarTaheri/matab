...
<div class="uk-container uk-container-center my-uk-container" >
    <form class="uk-form" id="mainForm">
        ...
        <div class="uk-grid uk-grid-preserve">
            ...
            <base:testBox styleClass="small" name="oldFileNumber" key="clinic.patient.oldFileNumber"/>
        </div>
        ...
        <div class="uk-grid uk-grid-preserve">
	        ...
	        <base:testBox styleClass="small" name="tel1" key="clinic.patient.tel1"/>
	         <base:testBox styleClass="small" name="description" key="clinic.patient.description" />
	    </div>
		<div class="uk-grid uk-grid-preserve">
        ...
        <div id="formAccordion" style="border: 1; margin-top: 15px;">
		    <h3 id="searchTab" style="	margin-bottom: 5px;
				...
				font-weight: bold;">اطلاعات تکمیلی</h3>
			 
			 <div id="search_back">
			        <div class="uk-grid uk-grid-preserve">
			        	<base:comboBox-buttonNew styleClass="small" name="job_id" key="clinic.patient.job" isListConstant="true" comboLoaderUrl="combo/loadJob" popupUrl="/popup/job" relativeSaveUrl="/job/save"/>
			        ...
			        <div class="uk-grid uk-grid-preserve">
			        	<base:comboBox styleClass="small" name="insurance_type_1_id" key="clinic.patient.insurancePrimType" comboLoaderUrl="combo/loadAllInsuranceOrgType1" isListConstant="true"  isMandatory="true"/>
			            <base:testBox styleClass="small" name="insurance_type_1_num" key="clinic.patient.insurancePrimTypeNumber"/>
			        </div>
			        <div class="uk-grid uk-grid-preserve">
			            <base:comboBox styleClass="small" name="insurance_type_2_id" key="clinic.patient.insuranceCompleteType" comboLoaderUrl="combo/loadAllInsuranceOrgType2" isListConstant="true"  isMandatory="true"/>
...
$(".checkingFields input[type='text']").focusout(function() {
