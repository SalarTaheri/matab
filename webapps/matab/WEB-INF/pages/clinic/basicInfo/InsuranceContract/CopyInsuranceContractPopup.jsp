...
<div id="insuranceContractCopyPopup" style="border: 1">
    <h3 style="">کپی قرارداد بیمه</h3>
    <div id="insuranceContractCopyPopup_back">
            ...
            <form class="uk-form" id="popupForm">
                <div class="uk-grid uk-grid-preserve">
					...
					<button class="uk-button uk-button-success uk-modal-close" type="button" onclick="javascript:popupCopy()" id="copyBtn" style="margin-right: 15%; padding-right: 5%; padding-left: 5%">
						<%=ResourceBoundleHolder.resourceBundle.getString("com.artonis.clinic.basicInfo.insuranceContract.copyItem")%>
					</button>
                </div>
            </form>
		</div>
...
function popupCopy(){
	...
	var insuranceContractId = $("#modal-copyItem_popup")[0].getAttribute("data-insurancecontractid");
	if(fromDate != "" && toDate != ""){
		var requestUrl = "${pageContext.request.contextPath}"+"/clinic/basicInfo/insuranceContract/insuranceContractCopy/" 
				+ insuranceContractId + "/" + fromDate + "/" + toDate ;
