...
<div id="employeeContractCopyPopup" style="border: 1">
    <h3 style="">کپی درصد خدمات پزشک</h3>
    <div id="employeeContractCopyPopup_back">
            ...
            <form class="uk-form" id="popupForm">
                <div class="uk-grid uk-grid-preserve">
					...
					<button class="uk-button uk-button-success uk-modal-close" type="button" onclick="javascript:popupCopy()" id="copyBtn" style="margin-right: 15%; padding-right: 5%; padding-left: 5%">
						<%=ResourceBoundleHolder.resourceBundle.getString("com.artonis.clinic.basicInfo.employeeContract.copyItem")%>
					</button>
                </div>
            </form>
		</div>
...
function popupCopy(){
	...
	var employeeContractId = $("#modal-copyItem_popup")[0].getAttribute("data-employeecontractid");
	if(fromDate != "" && toDate != ""){
		var requestUrl = "${pageContext.request.contextPath}"+"/clinic/basicInfo/employeeContract/employeeContractCopy/" 
				+ employeeContractId + "/" + fromDate + "/" + toDate ;
