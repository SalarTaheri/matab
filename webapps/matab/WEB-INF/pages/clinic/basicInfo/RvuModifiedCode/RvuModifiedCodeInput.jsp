...
<div class="uk-container uk-container-center my-uk-container" >
  ...
  <base:itemForm titleKeys="com.artonis.clinic.basicInfo.rvu,com.artonis.clinic.basicInfo.modifiedCode,com.artonis.clinic.basicInfo.ka" formItemTabViewJspFiles="RvuItemTabView.jsp,ModifiedCodeItemTabView.jsp,KaItemTabView.jsp"
                 formItemTabInputs="RvuItemTabInput,ModifiedCodeItemTabInput,KaItemTabInput" masterIdStr="rvuModifiedCode_id" insertWithoutPopup="true"/>
</div>
