...
<form class="uk-form" id="form-popup">
	...
	<div class="uk-grid uk-grid-preserve">
		<base:testBox styleClass="small" name="firstName" key="clinic.patient.firstName" />
		<base:testBox styleClass="small" name="lastName" key="clinic.patient.lastName" />
		<base:testBox styleClass="small" name="fatherName" key="clinic.patient.fatherName" />
	</div>
	<div class="uk-grid uk-grid-preserve">
