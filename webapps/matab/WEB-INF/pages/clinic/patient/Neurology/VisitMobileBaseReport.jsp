    ...
    <div id="accordion-resizer" style="height: 100%">
        <div id="tabs">
            <ul>
                ...
                <%--<li><a href="#labTestReport">Lab Test Report</a></li>--%>
                <%--<li><a href="#orderTab">Order</a></li>--%>
                <%--<li><a href="#followUpTab">FollowUp</a></li>--%>
                <%--<li><a href="#recommendTab">Recommendation</a></li>--%>
            </ul>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" id="labTestReport-table-id">
                                <img src="<c:url value='/resources/images/library-icon5.png' />" alt=''
                                     align='left'/>
                            </a>
                        </td>
                        <td>
