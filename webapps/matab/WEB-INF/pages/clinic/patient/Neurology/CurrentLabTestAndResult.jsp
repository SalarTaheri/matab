...
<div>
    <div>
        ...
        <div id="tableDiv">
            <table id="table" height="100%" width="100%" style="text-align: center;background-color: #ffffff;" border="2" dir="ltr">
                <tr>
                    <th id="labTest">
                        lab test
                    </th>
        ...
        <div>
            <iframe id="labTestResultPopupId"
                        src="${pageContext.request.contextPath}/clinic/patient/neurology/popup/${patientId}"
    ...
    <div id="dialog-f" title='select lab test' style="display:none;direction: ltr;height: 100% !important;">
        <form class="toPopup" style="direction: ltr">
            ...
            %>
                <table id="dialog-current-labtest-table">
                    <%--<tr id="all-select-c-labtest">--%>
                        <%--<td>--%>
                            <%--<input type="checkbox" id="all-select-c-labtest-checkbox"--%>
                                   <%--name="all-select-c-labtest-checkbox" style=" opacity: 0; "--%>
                                   <%--onclick="selectAllCurrentLabTestCheckBox(this)"/>--%>
                            <%--<lable for="all-select-c-labtest-checkbox">select all</lable>--%>
                        <%--</td>--%>
                    <%--</tr>--%>
                    <tr id="current-labtest-coding-<%=currentCoding%>" class="lineBorder">
                        <td style="width: 15%" align="right">
                            ...
                            <%--<input type="text" id="<%=medicalTest.getId().toString()%>-current-labtest-value"/>--%>
                        </td>
                        <td style="width: 5%">
                    ...
                    %>
                    <tr id="current-labtest-coding-<%=trId%>" class="lineBorder">
                        <td style="width: 15%" align="right">
...
function saveCurrentLabTest(newItemArray) {
    ...
    if (newItemArray.length > 0) {
        $.ajax({
            url:'${pageContext.request.contextPath}' + '/clinic/patient/neurology/saveMedicalTest/',
