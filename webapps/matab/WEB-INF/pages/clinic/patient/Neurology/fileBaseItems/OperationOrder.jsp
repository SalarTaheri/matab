...
<div>
    ...
    <div id="tableOperationDiv">
        <table id="tableOperation" height="100%" width="100%" style="text-align: center;" border="2" dir="ltr">
            <tr>
                <th id="operation">
                    procedure
                </th>
...
<div id="dialog-operation" title='select operation' style="display:none;direction: ltr;height: 100% !important;">
    <form class="toPopup" style="direction: ltr">
        ...
        <table>
            ...
            <%--<tr id="order-coding-<%=currentCoding%>" class="lineBorder">--%>
...
<%--$("#order-coding-" + "<%= idClassRemoveList.get(i) %>").removeClass();--%>
<%--<% } %>--%>
    ...
    elem.textcomplete([{
        ...
        search: function (term, callback) {
            Common.postJSON("${pageContext.request.contextPath}" +
                    "/clinic/patient/neurology/operationDescriptionAutoComplete/" + operationName, JSON.stringify({token:term}),
                    function (data) {
                        var tokens = [];
                        tokens.push(term);
