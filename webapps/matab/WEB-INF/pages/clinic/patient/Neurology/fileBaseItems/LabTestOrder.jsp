...
<div>
    <base:optiion widthValue="70" absulotePath="clinic/customize/userLabTest/combo/loadSelectedLabTestGet"
                  name="labTestOrders_customized" key="" noneSelectedText="select customized LabTest"
                  checkAllEventMethod="checkAllCustomizeLabTestEvent" clickEventMethod="clickCustomizeLabTestEvent" optgrouptoggleEventMethod="optgrouptoggleCustomizeLabTestEvent" unCheckAllEventMethod="unCheckAllCustomizeLabTestEvent">
    </base:optiion>
    <button name="customizedLabTest" id="customizedLabTest" onclick="customizedLabTestClick()">select customized LabTest
    </button>
</div>
<div>
    <%--<base:optiion widthValue="70" absulotePath="clinic/customize/userLabTestGroup/combo/loadSelectedLabTestGet"--%>
                  <%--name="labTestOrders_customized2" key="" noneSelectedText="select group LabTest">--%>
    <%--</base:optiion>--%>
</div>
