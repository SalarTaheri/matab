...
<%-- <html>
	<head>
		...
		<link rel="stylesheet" href="<c:url value='/resources/js/jquery.mobile-1.4.0/jquery.mobile-1.4.0.min.css' />" type="text/css"></link>
		<script type="text/javascript" src="<c:url value='/resources/js/jquery.mobile-1.4.0/jquery-1.8.3.js' />"></script>
		<script type="text/javascript" src="<c:url value='/resources/js/jquery.mobile-1.4.0/jquery.mobile-1.4.0.min.js' />"></script>
	</head>
	<body>
		<form>
