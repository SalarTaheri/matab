...
<div class="uk-container uk-container-center my-uk-container" >
    ...
    <form class="uk-form" id="mainForm">
        ...
        <div class="uk-grid uk-grid-preserve">
            <base:testBox name="filenumber" key="his.patient.fileCode" disabled="true" />
        </div>

        <div class="uk-grid uk-grid-preserve">
            <base:testBox name="firstname" key="clinic.patient.firstName" disabled="true" />
            <base:testBox name="lastname" key="clinic.patient.lastName" disabled="true" />
        </div>
        <div class="uk-grid uk-grid-preserve">
            <base:testBox name="weight" key="clinic.visit.clinicalInformation.weight" />
            <base:testBox name="bloodPressure" key="clinic.visit.clinicalInformation.bloodPressure" />
        </div>
    </form>
</div>
    ...
    $(document).ready(function() {
        ...
        $("#body-heade-mySaveAndClose").click(function(){
            ...
            $(document).ready(function() {
                ...
                jQuery.ajax ({
                    url: getBaseUrl() + "updateClinicalInformation",
                    type: "POST",
