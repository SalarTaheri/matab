...
<div>
    <jsp:include page="OperationOrder.jsp"/>
</div>
    ...
    function initrecommendAutocomplate(){
        $("#p-recommend").textcomplete([{
            ...
            search: function (term, callback) {
                Common.postJSON("${pageContext.request.contextPath}"+"/clinic/patient/visitMobileBase/recommendAutoComplete/" , JSON.stringify({token: term}), function(data){
                    var tokens = [];
                    tokens.push(term);
