...
<base:my-grid name="grid" transportReadUrl="${basePath}/grid-read" selectable="single">
	<base:my-grid-column title='com.artonis.lab.basicInfo.panel.name' field="name" width="50px"/>
	<base:my-grid-column title='com.artonis.lab.basicInfo.panel.code' field="code" width="50px"/>
