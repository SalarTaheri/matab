...
&lt;%&ndash;<base:pageTabViewHeader readUrl="transportReadUrl" removeUrl="transportRemoveUrl" updateUrl="" tabName="MemberSession"/>&ndash;%&gt;

&lt;%&ndash;/thinkRoom/memberMangement/members/grid-read&ndash;%&gt;
&lt;%&ndash;<form class="uk-form2-MemberSession" >&ndash;%&gt;
&lt;%&ndash;<base:my-grid-item name="MemberSession" transportReadUrl="${transportReadUrl}" transportRemoveUrl="${transportRemoveUrl}" masterIdStr="session_id">&ndash;%&gt;
<base:my-grid-item name="Member" transportReadUrl="/g01/thinkRoom/memberMangement/members/grid-read" transportRemoveUrl="${transportRemoveUrl}" masterIdStr="session_id">
...
<base:my-grid name="grid" transportReadUrl="${pageContext.request.contextPath}/thinkRoom/memberMangement/members/grid-read">
    <base:my-grid-column title='thinkroom.membermanagent.member.name'  field="name" width="50px"/>
    <base:my-grid-column title='thinkroom.membermanagent.member.lastname' field="lastname"  width="50px"/>
    <base:my-grid-column title='thinkroom.membermanagent.member.sex' field="sexStr"  width="50px"/>
    <base:my-grid-column title='thinkroom.membermanagent.member.job' field="job"  width="50px"/>
