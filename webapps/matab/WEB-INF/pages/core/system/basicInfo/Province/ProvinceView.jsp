...
<c:url var="transportReadUrl" value="/system/basicInfo/province/grid-read" />
<c:url var="transportRemoveUrl" value="/system/basicInfo/province/remove" />
<base:pageHeader></base:pageHeader>
	...
	<div class="k-rtl">
		<kendo:grid  name="grid" pageable="true" sortable="true" height="400"  columnReorder="true" columnResize="true" filterable="true" navigatable="true" >
	        ...
	        <kendo:grid-columns>
	            <kendo:grid-column title='<%=resource.getString("system.name")%>'  field="name" width="50px"/>
  ...
  <%--
   ...
   <<jsp:include page="ProvinceView.js"></jsp:include>
    <script>
        function onDelete(e){
            alert("aaa");
        }
