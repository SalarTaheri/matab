...
<div class="uk-container uk-container-center my-uk-container" >
	...
	<div id="gridButton"  >
		<base:mehrSys-sql-grid  sqlQueryKey="accountBookItem" pageSize="8" name="accountBookByItemGrid" selectable="multiple" isPopup="true"
	...
	<base:my-grid-column title='com.artonis.fnc.reports.books.accountBook.floatAccount2CodeName' field="floatAccountLevel2CodeName" width="200px" />
	<base:my-grid-column title='com.artonis.fnc.reports.books.accountBook.floatAccount3CodeName' field="floatAccountLevel3CodeName" width="100px" />
	<base:my-grid-column title='com.artonis.fnc.reports.books.accountBook.floatAccount4CodeName' field="floatAccountLevel4CodeName"  width="100px" />
