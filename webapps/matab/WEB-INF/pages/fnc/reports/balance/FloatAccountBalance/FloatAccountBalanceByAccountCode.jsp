...
<div class="uk-container uk-container-center my-uk-container" >
    ...
    <div class="uk-grid uk-grid-preserve">
		...
		<base:testBox name="fromPriceBy" disabled="true"  styleClass="midsmall" key="com.artonis.fnc.reports.balance.testBalance.fromPrice"/>
		<base:testBox name="toPriceBy" disabled="true"  styleClass="midsmall" key="com.artonis.fnc.reports.balance.testBalance.fromPrice"/>
	...
	<div class="uk-grid uk-grid-preserve">
		...
		<div align="center" style="padding-top: 1px">
			<button class="uk-button uk-button-success" type="button" onclick="javascript:printTestBalance2Col()" id="print2Btn">
				<%=ResourceBoundleHolder.resourceBundle.getString("fnc.btn.print")%>
			</button>
		</div>
	<div id="2Column"  >
		<base:mehrSys-sql-grid showOperation="false"  sqlQueryKey="floatAccounntBalanceByAccountCode" pageSize="10" name="grid" selectable="multiple" isPopup="false"
   ...
   <%} %>
	...
	<%if(request.getAttribute("balanceShowType") != null && request.getAttribute("balanceShowType").equals("2")){ %>
		<div align="center" style="padding-top: 1px">
			<button class="uk-button uk-button-success" type="button" onclick="javascript:printTestBalance4Col()" id="print4Btn">
				<%=ResourceBoundleHolder.resourceBundle.getString("fnc.btn.print")%>
			</button>
		</div>
	<div id="4Column"  >
...
<div class="uk-grid uk-grid-preserve"
  ...
  <%} %>
	...
	<%if(request.getAttribute("balanceShowType") != null && request.getAttribute("balanceShowType").equals("3")){ %>
		<div align="center" style="padding-top: 1px">
			<button class="uk-button uk-button-success" type="button" onclick="javascript:printTestBalance6Col()" id="print6Btn">
			<%=ResourceBoundleHolder.resourceBundle.getString("fnc.btn.print")%>
			</button>
		</div>
	<div id="6Column"  >
