...
<div class="uk-container uk-container-center my-uk-container" >
	...
	<base:my-grid-column title='com.artonis.fnc.reports.books.accountBook.accountCodeName' field="accountCodeName" width="100px" />
	<base:my-grid-column title='com.artonis.fnc.reports.books.accountBook.floatAccount1CodeName' field="floatAccountLevel1CodeName" width="100px" />
	<base:my-grid-column title='com.artonis.fnc.reports.books.accountBook.floatAccount2CodeName' field="floatAccountLevel2CodeName" width="20px" />
	<base:my-grid-column title='com.artonis.fnc.reports.books.accountBook.floatAccount3CodeName' field="floatAccountLevel3CodeName" width="20px" />
	<base:my-grid-column title='com.artonis.fnc.reports.books.accountBook.floatAccount4CodeName' field="floatAccountLevel4CodeName"  width="20px" />
