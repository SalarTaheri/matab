...
<div class="uk-container uk-container-center my-uk-container" >
   ...
   <div class="uk-grid uk-grid-preserve">
	...
	<base:my-grid-column title='com.artonis.fnc.reports.books.accountBook.accountCodeName' field="accountCodeName" width="45px" />
	<base:my-grid-column title='com.artonis.fnc.reports.books.accountBook.floatAccount1CodeName' field="floatAccountLevel1CodeName" width="40px" />
	...
	<base:my-grid-column title='com.artonis.fnc.reports.books.accountBook.description' field="description" width="70px" />
