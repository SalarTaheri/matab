...
<div class="uk-container uk-container-center my-uk-container" >
	<form class="uk-form" id="mainForm">
		...
		<div align="center" style="padding: 15px;">
		    ...
		    <button class="uk-button uk-button-success" type="button" onclick="javascript:newForm()" id="newBtn">
...
function newForm(){
	$("#id").val('');
	$("#systemName").val('');
    $("#systemName_Comb").data("kendoComboBox").text('');
	$("#pageName").val('');

	$("#pageEntityName").val('');
	$("#accountCodingType").val('');
    $("#accountCodingType_Comb").data("kendoComboBox").text('');
	$("#accountCodingId").val('');
    $("#accountCodingId_Comb").data("kendoComboBox").text('');
}
