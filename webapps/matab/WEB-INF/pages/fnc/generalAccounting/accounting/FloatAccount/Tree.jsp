...
<div class="uk-container uk-container-center my-uk-container" style=" height: 100%; ">
    ...
    <%--<form class="uk-form" id="mainForm">--%>
        <div class="k-rtl uk-grid uk-grid-preserve" style=" overflow-y: auto; overflow-x: auto; min-height: 100%; min-width: 100%  "   dir="rtl">
            <base:treeViewSearchable  name="aaa"  key="clinic.visit.labTestNames" dataLoaderController="/fnc/generalAccounting/accounting/floatAccount/treeview/loadAccountCoding" />
        </div>
    <%--</form>--%>
...
<script type="text/javascript">
    function callback_treeview_select_aaa(e){
        console.log(e);
//        if(e.modelID==0){
            window.location.href="${pageContext.request.contextPath}"+"/fnc/generalAccounting/accounting/floatAccount/edit/floatAccount/"+ e.modelID;
//        }
