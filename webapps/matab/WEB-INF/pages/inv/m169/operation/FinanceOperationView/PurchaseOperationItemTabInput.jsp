...
<%@page contentType="text/html;charset=UTF-8"%>
	...
	<form class="uk-form2-PurchaseOperationItem">
		...
		<div class="uk-grid uk-grid-preserve">
			...
			<table >
				<tr>
					...
					<td align="center"><base:checkbox disabled="true" name="tradingBelow10Percent" onChangeFunction="changeCheckbox()" style="width: 15px; margin-right: 10px" key="inventory.m169.operation.purchaseOperation.null"/></td>
				</tr>
			</table>
		</div>
		<div style="padding-top: 12px" class="turnItems">		
			...
			<div class="uk-grid uk-grid-preserve seller-dependant">
				...
				<base:testBox styleClass="small" name="person_fullName" key="inventory.m169.operation.purchaseOperation.person_id" disabled="true"/>
			</div>
			<div class="uk-grid uk-grid-preserve seller-dependant">
