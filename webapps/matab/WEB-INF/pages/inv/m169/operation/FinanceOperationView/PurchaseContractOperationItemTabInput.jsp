...
<%@page contentType="text/html;charset=UTF-8"%>
	...
	<form class="uk-form2-PurchaseContractOperationItem">
		...
		<div class="uk-grid uk-grid-preserve">
			...
			<base:testBox styleClass="small" name="contractSideTypeTxt" key="com.artonis.inv.m169.operation.purchaseContractOperation.contractSideType" disabled="true"/>
		...
		<div style="padding-top: 12px" class="turnItems">		
			<div class="uk-grid uk-grid-preserve">
				<base:testBox styleClass="small" name="personName" key="inventory.m169.operation.purchaseOperation.person_id" disabled="true"/>
				 <base:mDatePicker styleClass="small" disabled="true" name="startDate" key="com.artonis.inv.m169.operation.purchaseContractOperation.startdate"></base:mDatePicker>
				<base:mDatePicker styleClass="small" disabled="true"  name="finishDate" key="com.artonis.inv.m169.operation.purchaseContractOperation.endDate"></base:mDatePicker>
			...
			<div class="uk-grid uk-grid-preserve seller-dependant">
				<base:testBox styleClass="small" name="economic_no"  key="inventory.m169.operation.purchaseOperation.economicNo" disabled="true"/>
				...
				<base:testBox styleClass="small" name="foreignPersonNumber" disabled="true" styledivLabel="text-align: right;width:19%" key="inventory.m169.operation.purchaseOperation.foreignPersonCode"/>
			</div>
		</div>
		<div class="uk-grid uk-grid-preserve">
		...
		<div class="uk-grid uk-grid-preserve">
			...
			<base:testBox styleClass="small" name="postalCode" styledivLabel="text-align: right;width:19%" key="inventory.m169.operation.purchaseOperation.sellerPostalCode" disabled="true"/>
		
		</div>
		<div class="uk-grid uk-grid-preserve">
			<base:testBox styleClass="small" name="preCodeCity" key="inventory.m169.operation.purchaseOperation.cityCode" disabled="true"/>
			<base:testBox styleClass="small"  name="phoneno" key="inventory.m169.operation.purchaseOperation.sellerPhone" disabled="true"/>
		</div>
		<div class="uk-grid uk-grid-preserve">
