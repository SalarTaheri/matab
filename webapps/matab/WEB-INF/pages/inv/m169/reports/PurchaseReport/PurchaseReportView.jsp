...
<base:my-grid name="grid" transportReadUrl="${basePath}/grid-read" selectable="single">
	...
	<base:my-grid-column title='com.artonis.inv.m169.reports.count'  field="countPurchaseOperation" width="20px"/>
	<base:my-grid-column title='com.artonis.inv.m169.reports.price'  field="price" width="50px"/>
	<base:my-grid-column title='com.artonis.inv.m169.reports.tax'  field="tax" width="45px"/>
	<base:my-grid-column title='com.artonis.inv.m169.reports.toll'  field="toll" width="40px"/>
	...
	<base:my-grid-column title='com.artonis.inv.m169.basicInfo.companyPerson.nationalId'  field="nationalId" width="40px"/>
        ...
        <base:my-grid-schema-field name="countPurchaseOperation" type="string"/>
