...
<div class="uk-container uk-container-center my-uk-container" >
	<form class="uk-form" id="mainForm">
		...
		<div class="uk-grid uk-grid-preserve">
			<base:label  name="countSaleOperation" styleClass="verysmall" key="com.artonis.inv.m169.reports.count"></base:label>
     ...
     <div id="header-toolbar" align="left">
       	<base:buttonPermission key="fnc.btn.registerInfo" classNames="uk-button" id="saleReportInput-registerInfo-btn" onClick="javascript:saveSaleReport()" style="width: 100px; color: blue;"/>
        <base:buttonPermission key="fnc.btn.print" classNames="uk-button" id="saleReportInput-print-btn" onClick="javascript:myPrint()" style="width: 100px; color: green;"/>
        <base:buttonPermission key="fnc.btn.cancel" classNames="uk-button" id="saleReportInput-cancel-btn" onClick="javascript:showSaleReportView()" style="width: 100px; color: green;"/>
...
$(document).ready(function(){
	...
	$.getJSON(url, function (data) {
		...
		$('#countSaleOperation').val(data.countSaleOperation);
		$('#toll').val(data.toll);
		$('#tax').val(data.tax);
...
function showSaleReportView(){
	window.location = "${pageContext.request.contextPath}"+"/inventory/m169/reports/saleReport/";
}
function getPageObject(){
		...
		param.toll = $("#toll").val();
		param.countPurchaseOperation = $("#countSaleOperation").val();
...
function myPrint(){
	...
	jsonString = jsonString.replace(/\\/g, ':@:');
	window.location = "${pageContext.request.contextPath}"+"/inventory/m169/reports/saleReport/print/" + jsonString;
}
</script>
