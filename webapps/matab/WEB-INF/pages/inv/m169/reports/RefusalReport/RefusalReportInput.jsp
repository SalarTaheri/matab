...
<div class="uk-container uk-container-center my-uk-container" >
	<form class="uk-form" id="mainForm">
		...
		<div class="uk-grid uk-grid-preserve">
			<base:label  name="countRefusalOperation" styleClass="verysmall" key="com.artonis.inv.m169.reports.count"></base:label>
     ...
     <div id="header-toolbar" align="left">
     	<base:buttonPermission key="fnc.btn.registerInfo" classNames="uk-button" id="refusalReportInput-registerInfo-btn" onClick="javascript:saveRefusalReport()" style="width: 100px; color: blue;"/>
        <base:buttonPermission key="fnc.btn.print" classNames="uk-button" id="refusalReportInput-print-btn" onClick="javascript:myPrint()" style="width: 100px; color: green;"/>
        <base:buttonPermission key="fnc.btn.cancel" classNames="uk-button" id="refusalReportInput-cancel-btn" onClick="javascript:showRefusalReportView()" style="width: 100px; color: green;"/>
    </div>
</form>
</div>
...
$(document).ready(function(){
	...
	$.getJSON(url, function (data) {
		...
		$('#countRefusalOperation').val(data.countRefusalOperation);
		$('#toll').val(data.toll);
		$('#tax').val(data.tax);
...
function showRefusalReportView(){
	window.location = "${pageContext.request.contextPath}"+"/inventory/m169/reports/refusalReport/";
}
...
function myPrint(){
	...
	jsonString = jsonString.replace(/\\/g, ':@:');
	window.location = "${pageContext.request.contextPath}"+"/inventory/m169/reports/refusalReport/print/" + jsonString;
}
</script>
