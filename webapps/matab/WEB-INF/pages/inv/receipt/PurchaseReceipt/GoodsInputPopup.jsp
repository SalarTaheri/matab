...
<%
	String loadPricingUrl=request.getContextPath()+"/inv/receipt/purchaseReceipt/combo/loadPricing";
...
<script type="text/javascript">
	...
	function _goodsCategory_id_change(e) {
		...
		if (!!goodsCategoryId) {
			var url = "${pageContext.request.contextPath}"  + "/inv/receipt/purchaseReceipt/popup/loadGoodsTypeNameByGoodsCategoryId/" + goodsCategoryId;
...
<form class="uk-form" id="form-popup">
	...
	<div class="uk-grid uk-grid-preserve">
		<base:comboBox styleClass="small" name="pricing" key="com.artonis.inv.basicInfo.goods.pricing" comboLoaderUrl="<%=loadPricingUrl%>" isUrlComplete="true"/>
...
<script type="text/javascript">
	...
	var url = "${pageContext.request.contextPath}" +  "/inv/receipt/purchaseReceipt/popup/getNewGoodsCode";
	$.getJSON(url, function(data) {
		$("#code").val(data.code);
	});
</script>