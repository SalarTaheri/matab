...
<%@page contentType="text/html;charset=UTF-8"%>
	...
	<form class="uk-form2-DirectlyConsumptionReceiptAdditionSubtractionItem" >
		<div class="uk-grid uk-grid-preserve">
			<base:comboBox comboLoaderUrl="combo/loadAdditionSubtraction" styleClass="small" name="additionSubtraction" key="com.artonis.inv.receipt.purchaseReceiptAdditionSubtraction.additionSubtraction"/>
			<base:testBoxNumericEx styleClass="small" name="price" key="com.artonis.inv.receipt.purchaseReceiptAdditionSubtraction.price"/>
			<base:comboBox comboLoaderUrl="combo/loadAllValueAddedTax" styleClass="small" name="valueAddedtax" key="com.artonis.inv.receipt.purchaseReceiptAdditionSubtraction.valueAddedtax"/>
