				...
				<ul style="width: 220px">
					<li>
						<div id="template" style="padding: 10px; width: inherit">
							<form id="FinanceYear-active" action="">
	...
	<table  id="body-table1" height="100%" width="100%" >
		<tr height="100%" width="100%">
			<td id="body-side-left"  height="100%" width="100%">
				...
				<div id="body-content" class="body-content-class" >
...
//						this.value=1;
		    ...
		    if(window.location.href.indexOf("/editWP/")  > 0){
			 ...
			 //
            fixTextAreas();
		    if(contextPath+'/'!=basePath){
                $(".body-content-class").css('background-image','none');
                $(".body-content-class").css('background','-webkit-gradient(linear, left top, left bottom, color-stop(0%,#f2f5f6), color-stop(37%,#e3eaed), color-stop(100%,#c8d7dc))');
            }


            if (window.location.href == "http://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath}/") {
                ...
                if (defaultPageController != "null" && defaultPageController.trim() != "") {
                    ...
                    window.location.href = "${pageContext.request.contextPath}/" + defaultPageController;
                }
            }
		});
