/*! wPaint - v2.5.0 - 2014-03-01 */ ! function(a) {
    ...
    b.prototype = {
        ...
        _callShapeFunc: function(a) {
            ...
            "Down" === c && this.options.onShapeDown ? this.options.onShapeDown.apply(this, [a]) : "Move" === c && this.options.onShapeMove ? this.options.onShapeMove.apply(this, [a]) : "Up" === c && this.options.onShapeUp && this.options.onShapeUp.apply(this, [a])
        },
