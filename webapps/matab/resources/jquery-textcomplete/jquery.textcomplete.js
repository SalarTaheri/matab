      ...
      renderList: function (data) {
        ...
        if (data.length) {
          if (!this.listView.shown) {
            ...
            this.listView.$el.css("right", this.listView.$el.css("left"));
            //var myWidth = parseInt(this.listView.$el.css("width"));
            var myRight = parseInt(this.listView.$el.css("right"));         
            //console.log(myRight + " --- " + myWidth);
            this.listView.$el.css("right", (myRight - 100) + "px");
            //this.listView.$el.css("right", (myRight) + "px");
            ////////this.listView.$el.css("left", "auto");
            this.listView.$el.css("left", "0px");
          }
