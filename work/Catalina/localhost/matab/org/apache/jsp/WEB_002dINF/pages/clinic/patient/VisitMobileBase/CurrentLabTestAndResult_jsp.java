...
public final class CurrentLabTestAndResult_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/lib/spring-webmvc-4.2.2.RELEASE.jar", Long.valueOf(1484491195000L));
...
String value=medicalTestVisitQueue.getValue();
 ...
 if(!(request.getAttribute("labTestResultWithValueList") instanceof String)){
    ...
    for (DBObject dbObject : labTestResultWithValueList) {
      ...
      out.write("var value = '");
      out.print(StringEscapeUtils.escapeEcmaScript(value));
      out.write("';\r\n");
      out.write("$('#table').append('<tr id=\"' + medicaltestId + '-row' + '\"></td><td contente=\"true\">' + medicaltestname + '</td><td contente=\"true\"> <textarea onkeyup=\"textArea_onKeyUp(this)\" id=\"' + medicaltestId + '\" style=\" width: 100%;resize: none; \">");
      out.print(StringEscapeUtils.escapeEcmaScript(value));
      out.write("</textarea></td><td><input type=\"button\" value=\"delete\" class=\"uk-button-mini uk-button-danger\" onclick=\"deleteClick(this)\" /></td><td><input type=\"checkbox\" id=\"'+medicaltestId+'-currentLabtest-checkbox-highlight'+'\"</td></tr>' + '');\r\n");
      out.write("if(labTestIsHighlight=='true'){\r\n");
      out.write("    $('#'+medicaltestId+'-currentLabtest-checkbox-highlight').prop('checked',true)\r\n");
      out.write("}\r\n");
      out.write("var allUserLabTest = $(\"#dialog-f\").find(\":checkbox\");\r\n");
      out.write("for (var w = 0; w < allUserLabTest.length; w++) {\r\n");
      out.write("    if (allUserLabTest[w].id == medicaltestId + '-current-labtest-checkbox') {\r\n");
      out.write("        allUserLabTest[w].checked = true;\r\n");
      out.write("        $('#'+medicaltestId+'-current-labtest-value').val(value);\r\n");
      out.write("    }\r\n");
      out.write("}\r\n");
      ...
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("        if (found == false && arrayCheckedLabTest[i].id != 'all-select-c-labtest-checkbox') {\r\n");
      ...
      out.write("        $('#table').append('<tr id=\"' + labTestId + '-row' + '\"></td><td contente=\"true\">' + labTestText + '</td><td contente=\"true\"> <textarea  onkeyup=\"textArea_onKeyUp(this)\" id=\"' + labTestId + '\" style=\" width: 100%;resize: none; \"/></td><td><input type=\"button\" value=\"delete\"  class=\"uk-button-mini uk-button-danger\" onclick=\"deleteClick(this)\" /></td><td><input type=\"checkbox\" id=\"'+labTestId+'-currentLabtest-checkbox-highlight'+'\"</td></tr>' + '');\r\n");
      out.write("    }\r\n");
  ...
  private boolean _jspx_meth_c_005furl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/pages/clinic/patient/VisitMobileBase/CurrentLabTestAndResult.jsp(619,15) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
